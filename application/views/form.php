...
<html>
  <head>
    ...
    <link rel="stylesheet" href="assets/colorpicker/jquery.colorpicker.css"/>
...
<script src="assets/colorpicker/jquery.colorpicker.js"></script>
      ...
      $.ajax({
        ...
        success: function (data) {
         if(data && data.status == true){
          ...
          toastr.error(data.error,'Errors');
         }
        }
      });
     } 
